...
public class DesignTacoWebController {
    ...
    Logger logger = LoggerFactory.getLogger(DesignTacoWebController.class);
    ...
    @Autowired
    public DesignTacoWebController(IngredientRepository repository, TacoRepository tacoRepository) {
